...
It looks like we will soon have more rabbits!"""
        ...
        while (true) {
            ...
            val input = readln() // Read the input once
            ...
            try {
                val x = input.toInt() // Convert the input to an integer
                if (x in animals.indices) { // Check if the index is valid
                    println(animals[x])
                } else {
                    println("Invalid number. Please enter a number between 0 and ${animals.size - 1}.")
                }
